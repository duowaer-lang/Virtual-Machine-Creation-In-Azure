...
<p>
<img src="https://github.com/duowaer-lang/Virtual-Machine-Creation-In-Azure/blob/main/step%207.1.png?raw=true" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<p>
- Step 7: Click on review + create and create once again at the bottom of the page (it will be blue)
</p>
